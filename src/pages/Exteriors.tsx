                ...
                <div className="relative z-10 bg-white/90 rounded-2xl shadow-2xl flex max-w-5xl w-full overflow-hidden min-h-[340px] max-h-[500px]">
                    ...
                    <div className="basis-1/2 flex flex-col justify-center p-10">
                        <h2 className="text-4xl md:text-5xl font-extrabold mb-6">
                            Exteriors That Define Identity
                        </h2>
                        <p className="text-lg text-gray-800 mb-8">
                            Our exterior designs combine aesthetics, innovation, and purpose to create striking facades that make a lasting impression. From modern architectural styles to timeless classics, we craft exteriors that balance form and function — enhancing both beauty and durability. Every detail, from material selection to structural harmony, is carefully planned to reflect your vision while complementing the surrounding environment.
                        </p>
                    </div>
