...
// function Footer() {
//   return (
//     // <footer className="bg-gray-900 text-center text-gray-200 py-6 mt-12">
...
//                 <div className="text-center text-gray-300 text-sm mb-2">
//                   Archinest Associates Pvt Ltd,<br />
//                   274, ydjvk Building, thdckv, jgjgigogp - 530476
//                 </div>
//                 <a
//                   href="https://goo.gl/maps/example"
//                   target="_blank"
...
//           <div className="flex items-center mb-1"><FaPhoneAlt className="mr-2" /> 0484-123 4567</div>
//           <div className="flex items-center mb-1"><FaWhatsapp className="mr-2" /> +91 12345 67890</div>
//           <div className="flex items-center mb-1"><FaEnvelope className="mr-2" /> info@archinest.com</div>
//           {/* Socials */}
...
//         Copyright © {new Date().getFullYear()} Archinest | All Rights Reserved | Powered By Aieera
//       </div>
//     </footer>
